...
#[tauri::command]
async fn worktree_create(input: worktree::CreateWorktreeInput) -> Result<worktree::WorktreeInfo, String> {
    worktree::create_worktree(input)
}

#[tauri::command]
async fn worktree_list(input: worktree::ListWorktreesInput) -> Result<Vec<worktree::WorktreeInfo>, String> {
    worktree::list_worktrees(input)
}

#[tauri::command]
async fn worktree_remove(input: worktree::RemoveWorktreeInput) -> Result<bool, String> {
