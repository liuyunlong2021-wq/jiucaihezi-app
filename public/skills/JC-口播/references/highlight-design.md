...
[
  {
    ...
    "position": "top",
    "animation": "bounceIn",
    "stickers": [{"type": "question", "icon": "?"}, {"type": "spark", "icon": "✦"}]
  },
  {
    "id": "hl_001",
    "start": 7.3, "end": 10.1,
  ...
  },
  {
    ...
    "position": "top",
    "animation": "slideLeft",
    "stickers": [{"type": "question", "icon": "?"}, {"type": "contrast_arrow", "icon": "↗"}]
  },
  {
    "id": "hl_003",
    "start": 25.4, "end": 28.2,
    ...
    "position": "bottom",
    "animation": "elasticIn",
    "stickers": [{"type": "step_badge", "icon": "STEP"}, {"type": "spark", "icon": "✦"}]
  },
  {
    "id": "hl_004",
    "start": 40.3, "end": 43.1,
    ...
    "position": "top",
    "animation": "bounceIn",
    "stickers": [{"type": "case_tag", "icon": "案例"}, {"type": "spark", "icon": "✦"}]
  }
]
```
