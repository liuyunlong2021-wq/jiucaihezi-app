---
name: jc-chat-wiki
description: Use when a user asks to organize, archive, or convert project conversation records into a Wiki knowledge base.
triggers:
  - 对话转Wiki
  - 对话沉淀
  - 对话归档
...
jc-chat-wiki      → 对话沉淀（对话→Wiki）★ 新增
jc-raw-wiki       → 日常压缩（.raw/ → wiki/）
jc-jian-wiki       → 巡检（全库体检）
```
