...
Workflow Registry: `{baseDir}/data/my-workflows.json`
...
For internal production pipelines, prefer registered workflow aliases from
`{baseDir}/data/my-workflows.json` over hardcoded webappId/nodeId pairs.
