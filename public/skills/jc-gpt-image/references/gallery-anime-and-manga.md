...
### No. 4 · Manga relationship map — _A Tale of Two Cities_
...
**核心技法**：铁线描黑色勾勒（粗细均匀，无压感变化）、单线平涂无渐变、矿物颜料色感（金/朱砂/石青/石绿/藤黄）、京剧脸谱化造型、散点透视、装饰性飘带与祥云。

**变体控制**：

- 🟡 **明亮华美**（大闹天宫向）：金红主调，暖色祥云，琼楼玉宇，喜庆庙堂感
- 🔵 **悲壮沉郁**（哪吒闹海向）：深青/银白/朱红大色块，海水江崖，狂风暴雨，悲剧英雄
- 🟣 **暗黑诡谲**（金猴降妖向）：深靛/血赤/紫黑，妖雾鬼火，夜色荒山，成人向恐怖

```text
A classic Chinese animation still in the Shanghai Animation Film Studio gongbi heavy-color style (工笔重彩). Landscape 16:9.

[TONE SELECTION — choose one:]
BRIGHT: Golden-red celestial palace, auspicious clouds, vermillion pillars, festive legendary mood. Monkey King in golden armor performing Peking opera theatrical pose.
TRAGIC: Dark indigo ocean waves, silver lightning, a young hero boy with red sash standing defiant against storm and sea monsters, traditional wave patterns (海水江崖).
DARK: Night mountain wilderness, purple-black demonic mist, Monkey King with piercing golden eyes (火眼金睛) mid-strike, skeletal transformations in shadows.

Art direction: bold uniform iron-wire outlines (铁线描), flat clean color blocks with zero gradient shading, Chinese mineral-pigment palette (gold, vermillion red, azurite blue, malachite green, rattan yellow), decorative cloud patterns (祥云) and flowing ribbons, Peking opera-inspired facial makeup and postures, Dunhuang-mural compositional flatness. No Japanese anime cel shading, no modern 3D rendering, no Western cartoon, no realistic lighting or shadows. Pure classical Chinese animated feature aesthetic.
```

### No. 14 · 美影厂水墨动画风格 (Ink-Wash Animation)

- Image: _暂无参考图_
- Metadata: Anime & Manga · `landscape` · `1536x1024` · Curated

**中文说明**：上海美术电影制片厂独创的世界级动画语言——纯水墨无勾线，以墨色浓淡干湿和留白叙事。本条目覆盖小蝌蚪找妈妈和山水情两部代表作，从齐白石花鸟到文人泼墨山水，涵盖水墨动画的完整光谱。

**核心技法**：无轮廓线、墨分五色（焦浓重淡清）、生宣晕染质感、大面积留白、以笔触速度和含水量控制墨色扩散。

**变体控制**：

- 🦐 **花鸟写意**（齐白石/小蝌蚪向）：虾蟹鱼蛙，简洁圆润笔触，淡彩点缀，童趣天真
- ⛰️ **文人泼墨**（山水情向）：狂放大写意，泼墨山水，古琴意境，苍劲枯笔，极简留白

```text
A classic Chinese ink-wash animation still in the Shanghai Animation Film Studio style (水墨动画). Landscape 16:9.

[STYLE SELECTION — choose one:]
FLOWER-BIRD: Small black tadpoles and translucent goldfish rendered in varying ink densities, lotus stems in bold strokes, xuan paper texture, playful Qi Baishi xieyi manner.
LITERATI: Monumental splashed-ink mountain peaks, an old qin master and young boy on a rocky ledge, massive negative space (留白), dry-brush texture, meditative and profound.

Art direction: pure Chinese ink-wash painting (水墨画) — no outlines whatsoever, no cel shading, no flat colors. Five tones of ink from jet black to pale grey (焦浓重淡清), wet-ink bleeding with soft edges, dry-brush scratchy texture, negative space as active compositional element, subtle xuan paper grain. Absolutely no Japanese sumi-e imitation, no Western watercolor, no digital gradients. Pure Shanghai Animation Film Studio ink-wash magic.
```

### No. 15 · 美影厂敦煌壁画动画风格 (Dunhuang Mural Animation)

- Image: _暂无参考图_
- Metadata: Anime & Manga · `landscape` · `1536x1024` · Curated

**中文说明**：上海美术电影制片厂 1981 年《九色鹿》，取材敦煌莫高窟第 257 窟北魏壁画《鹿王本生图》。赭红底色、飞天飘带、北魏铁线描的拙朴力量感。中国动画史上唯一的敦煌壁画风格。适用于西域神话、丝绸之路、佛教本生故事、沙漠绿洲等题材。

**核心要素**：北魏拙朴铁线描、赭红/石青/石绿/金粉矿物配色、飞天造型与飘带、本生故事连环画式构图、风化剥落的历史质感。

```text
A classic Chinese animation still in the Dunhuang mural style of Shanghai Animation Film Studio's "The Nine-Colored Deer" (九色鹿, 1981). Landscape 16:9.

A magnificent nine-colored deer with luminous white body and shimmering jewel-toned spots (ochre, vermillion, turquoise, malachite, gold), noble antlers branching like coral, standing on a rocky outcrop. Flying apsaras (飞天) with flowing ribbons in faded mineral colors float above.

Backdrop: Dunhuang desert landscape — ochre sand dunes, distant snow peaks, Silk Road camel caravan, a turquoise oasis, decorative Northern Wei lotus-petal border frame.

Art direction: authentic Northern Wei dynasty (北魏) Dunhuang cave mural aesthetic — dominant ochre-red ground, bold weighty iron-wire outlines with archaic irregularity, heavily applied mineral pigments (石青/石绿/金粉), deliberately weathered and aged feeling, continuous narrative frieze composition. No Japanese anime, no 3D, no Western cartoon. Ancient Buddhist grotto art brought to life.
```

### No. 16 · 美影厂剪纸皮影动画风格 (Paper-Cut & Shadow Puppet Animation)

- Image: _暂无参考图_
- Metadata: Anime & Manga · `landscape` · `1536x1024` · Curated

**中文说明**：上海美术电影制片厂的中国特色动画形式——关节分段活动的剪纸/皮影人物，浓烈民俗配色，手工镂刻质感。本条目覆盖天书奇谭和葫芦兄弟两部代表作。

**核心技法**：平面关节分段人物（类似皮影）、浓烈民俗配色、手工镂刻边缘微瑕、层叠透光质感。

**变体控制**：

- 🏮 **年画混合**（天书奇谭向）：桃红/翠绿/明黄/湖蓝，戏曲丑角五官（豆豆眼/八字眉），江南白墙黛瓦，诙谐夸张
- ✂️ **纯剪纸**（葫芦兄弟向）：红/橙/黄/绿/青/蓝/紫七色体系，山村石洞场景，质朴手作温暖

```text
A classic Chinese paper-cut animation still in the Shanghai Animation Film Studio style (剪纸/皮影动画). Landscape 16:9.

[STYLE SELECTION — choose one:]
NEW-YEAR-PAINTING: Round-faced boy (蛋生) with wide eyes, floating talisman scroll, three fox spirits with exaggerated opera-clown faces, Jiangnan white-wall grey-roof architecture, peach-pink and emerald-green palette.
PURE-PAPER-CUT: Seven color-coded boy heroes (red/orange/yellow/green/cyan/blue/purple) in heroic group pose, snake demoness and scorpion spirit in cave entrance, calabash vine on cliff, bold saturated folk colors.

Art direction: flat jointed paper-cut figures with visible articulation seams, richly colored translucent paper texture, bold hand-cut edges with slight irregularity, layered diorama depth, strong folk-art handicraft warmth. No 3D rendering, no digital smoothness, no Japanese anime cel shading. Handmade Chinese paper-cut animation charm.
```

### No. 17 · 美影厂定格动画风格 (Stop-Motion Puppet Animation)

- Image: _暂无参考图_
- Metadata: Anime & Manga · `landscape` · `1536x1024` · Curated

**中文说明**：上海美术电影制片厂《阿凡提的故事》系列（1979-1988），中国最经典的黏土/木偶定格动画。新疆维吾尔族美学——圆顶清真寺、巴扎集市、葡萄架、热瓦甫琴。倒骑小毛驴的阿凡提形象深入人心。适用于民间智者故事、丝绸之路、中亚民族风题材。

**核心要素**：黏土/木偶材质感、手工制偶的微瑕真实感、织物纹理可见、微缩场景道具、新疆维吾尔族建筑与服饰美学、明亮干燥的中亚色调。

```text
A classic Chinese stop-motion puppet animation still in the Shanghai Animation Film Studio "Avanti" style (阿凡提的故事). Landscape 16:9.

The folk hero Avanti — elongated face, pointed goatee, white turban (色兰), striped Uyghur chapan robe — riding backward on his small grey donkey with a knowing smirk and one raised finger. The donkey has slightly uneven clay-textured ears and a comically stubborn expression.

Backdrop: Xinjiang Silk Road oasis village — turquoise-domed mosque with geometric tiles, mud-brick houses with carved balconies, grapevine trellises, tandoor clay oven, distant poplars, bright Central Asian sunlight.

Art direction: tangible stop-motion aesthetic — visible clay surface texture, slightly imperfect handcrafted feel, fabric weave visible on robe, miniature set details. Palette: warm earth tones (ochre, sandy beige), turquoise, sky blue, pomegranate red, emerald green. Humorous folk-tale mood. No CGI smoothness, no 3D rendering, no Disney-style squash-and-stretch, no photorealistic lighting. Handmade Chinese puppet animation charm.
```

### No. 18 · 美影厂折纸动画风格 (Origami Animation)

- Image: _暂无参考图_
- Metadata: Anime & Manga · `landscape` · `1536x1024` · Curated

**中文说明**：上海美术电影制片厂虞哲光导演独创的世界唯一折纸动画技法——用彩色折纸角色逐格拍摄，棱角分明、几何感强烈。代表作《聪明的鸭子》(1960)、《一棵大白菜》。适合幼儿题材、几何抽象风格、手工折纸质感场景。

**核心要素**：折纸棱角几何造型（三角/菱形/梯形面）、无曲线轮廓、彩色卡纸质感（正反面色差可见）、折痕线清晰、扁平但有三面转折的伪 3D 感、稚拙童趣。

```text
A classic Chinese origami animation still in the style of Shanghai Animation Film Studio (折纸动画), pioneered by director Yu Zheguang. Landscape 16:9.

A simple geometric duckling figure composed entirely of folded yellow paper triangles — a sharp triangular beak, diamond-shaped wings with visible crease lines, flat orange paper feet — waddling across a pond surface also made from layered blue paper sheets with fold-line wave patterns. Beside it, a green paper frog with angular folded legs and a white paper lotus flower with crisp petal folds.

Backdrop: a miniature world built from folded colored paper — layered green triangles for grass, a cylindrical brown paper tree trunk, square orange paper leaves, a bright yellow paper sun with sharp rays in the corner, all with visible fold creases and slight paper texture.

Art direction: pure folded-paper stop-motion aesthetic — every element visibly made from colored craft paper with sharp geometric edges, flat triangular and diamond facets, visible fold lines and crease shadows, slight gaps between paper layers, matte paper surface with no gloss. Bright kindergarten palette: sunflower yellow, grass green, sky blue, tomato red, kraft brown. Whimsical handmade charm, childlike simplicity. No smooth curves, no 3D rendering, no clay texture, no digital. Pure Chinese origami animation magic.
```

### No. 19 · 美影厂漫画极简风格 (Comic Minimalism)

- Image: _暂无参考图_
- Metadata: Anime & Manga · `landscape` · `1536x1024` · Curated

**中文说明**：上海美术电影制片厂 1980 年代阿达导演的极简漫画风动画——韩羽造型设计、大面积留白、以少胜多的东方智慧。代表作《三个和尚》(1980)获柏林银熊奖，《超级肥皂》(1986)获中国电影金鸡奖。适合寓言哲理、幽默讽刺、极简留白美学题材。

**核心要素**：韩羽式极简人物（圆头圆身简笔五官）、大面积纯色背景留白、戏曲锣鼓节奏替代对白、以构图和动作节奏叙事、少即是多的东方美学。

```text
A classic Chinese minimalist comic animation still in the style of Shanghai Animation Film Studio's "Three Monks" (三个和尚, 1980, directed by A Da). Landscape 16:9.

Three cartoon Buddhist monks with ultra-simplified Han Yu-style character design — round bald heads with minimal facial features (just dot eyes and line mouths), cylindrical bodies in red, blue, and yellow robes respectively — standing in comic confrontation around a water bucket. One tall and thin with a long face, one short and plump with a round face, one medium with a clever expression. Their postures are exaggerated and theatrical, like Peking opera mime.

Backdrop: nearly empty composition with vast negative space — a simple ink-brush mountain outline on the horizon, a minimal temple roof with three curved eaves in the distance, a single bare tree branch, otherwise pure white/cream blank paper background. The emptiness IS the composition.

Art direction: Han Yu's comic minimalism — extreme simplification of form, thick bold outlines, flat unmodulated color fills, vast negative space (留白) as active visual element, theatrical mime-like posing, no dialogue required (visual storytelling through action and rhythm), muted earthy palette (monk grey, brick red, indigo, ochre, cream). Humorous, philosophical, profoundly Chinese. No detail clutter, no shading, no backgrounds unless absolutely necessary. Let the empty space speak.
```

### No. 20 · 美影厂水墨剪纸风格 (Ink-Wash Paper-Cut / 拉毛剪纸)

- Image: _暂无参考图_
- Metadata: Anime & Manga · `landscape` · `1536x1024` · Curated

**中文说明**：上海美术电影制片厂胡进庆导演发明的「拉毛剪纸」技法——在水墨画稿基础上，用撕毛边的纤维剪纸代替剪刀裁剪，实现水墨晕染的毛茸边缘效果。代表作《鹬蚌相争》(1983)获柏林银熊奖，《猴子捞月》(1981)。是水墨动画和剪纸动画之间的桥梁技法。

**核心要素**：水墨画稿为底+撕毛纤维边缘（非剪刀光滑切线）、宣纸撕扯的毛边肌理、水墨晕染色调（浓淡渐变）、皮影关节活动结构、介于水墨写意和剪纸装饰之间的独特平衡。

```text
A classic Chinese ink-wash paper-cut animation still in the style of Shanghai Animation Film Studio's "The Snipe and the Clam" (鹬蚌相争, 1983, directed by Hu Jinqing). Landscape 16:9.

A long-beaked snipe bird and a large freshwater clam locked in combat at a riverbank — the snipe's beak clamped inside the clam's shell, both pulling in opposite directions. The snipe's feathers have softly torn fibrous edges (拉毛) that mimic ink-wash bleeding, its body rendered in layered grey ink washes. The clam's shell has irregular torn-paper edges with visible paper fiber texture.

Backdrop: riverbank scene — reeds and water plants with torn-paper silhouette edges, the river surface suggested by horizontal torn strips of progressively lighter grey-blue paper, distant willow branches hanging like torn paper ribbons, morning mist as soft paper-fiber haze.

Art direction: the "pulled-wool paper-cut" (拉毛剪纸) technique — paper is torn rather than cut, creating soft fibrous edges that mimic Chinese ink-wash bleeding (水墨晕染). Jointed flat paper figures like traditional paper-cuts, but with organic irregular edges instead of clean scissor lines. Monochromatic ink palette with subtle warm grey variations, visible paper fiber texture, transparent layered depth. A bridge between ink-wash painting and paper-cut animation. No hard scissor-cut edges, no cel shading, no digital. Pure Hu Jinqing's revolutionary technique.
```
