...
| Video / 3D | `rh-video-v31-fast`, `rh-3d-text`, `rh-3d-image`, `rh-seedance2-text-video`, `rh-seedance2-image-video`, `rh-seedance2-multimodal-video`, `rh-grok-text-video`, `rh-grok-image-video`, `rh-grok-video-edit`, `rh-aiapp-fast-digital-human`, `rh-aiapp-digital-human`, `rh-aiapp-director` |
...
1. rh-adapter Docker 容器启动，`GET /health` 返回模型清单。
2. `GET /rh/tasks/test` 能到达 rh-adapter；测试 task 不存在时允许返回 404。
3. NewAPI 模型列表包含上面的 26 个 RH 模型。
