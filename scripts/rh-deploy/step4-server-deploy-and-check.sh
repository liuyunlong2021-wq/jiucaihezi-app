...
IMAGE_MODEL_LIST="rh-pro-image,rh-image-v2,rh-gpt2-image,rh-gpt2-text"
...
AUDIO_MODEL_LIST="rh-speech-hd,rh-speech-turbo,rh-music,rh-voice-clone,rh-aiapp-voice-clone,rh-aiapp-voice-design"
