...
const REMOVED_MODELS = /rh-mimic|rh-digital-human|rh-voice-design|rh-kling-v30-pro|rh-veo-31-|rh-seedance2(?!-)/
...
test('RH NewAPI channel config carries the full 26 model list and no adapter secret', () => {
