...
const REMOVED_MODELS = /rh-3d-|rh-mimic|rh-digital-human|rh-voice-design|rh-kling-v30-pro|rh-veo-31-|rh-seedance2(?!-)/
...
test('RH NewAPI channel config carries the full 24 model list and no adapter secret', () => {
