...
// 磁盘吃满。脚本的真实执行环境是服务器，这里在临时目录里跑同一份脚本。
...
test('prune-updates keeps the newest N version directories and nothing else', () => {
...
test('prune-updates never deletes the version latest.json points at', () => {
...
test('prune-updates does nothing when there is nothing to prune', () => {
...
test('prune-updates reads its target and keep count from arguments', () => {
