...
const wave1FocusedTests = [
  ...
  'src/components/canvas/__tests__/canvasErase.test.ts',
  'src/components/mcp/__tests__/mcpManagerPanel.test.ts',
  'src/components/auth/__tests__/loginKeySeparation.test.ts',
  ...
  'src/runtime/memory/__tests__/markdownWikiLinkInput.test.ts',
  'src/runtime/memory/__tests__/adaptationWikiScaffold.test.ts',
  'src/runtime/memory/__tests__/markdownSplit.test.ts',
  'src/runtime/memory/__tests__/storyImport.test.ts',
  'src/runtime/memory/__tests__/storyAnalysis.test.ts',
  'src/runtime/memory/__tests__/conversationTranscript.test.ts',
  'src/runtime/memory/__tests__/conversationSplit.test.ts',
  'src/runtime/memory/__tests__/memoryChat.autoindex.test.ts',
  'src/runtime/memory/__tests__/memoryChat.context.test.ts',
  'src/runtime/memory/__tests__/memoryChat.retirement.test.ts',
  'src/runtime/memory/__tests__/memoryChat.skill.test.ts',
  'src/runtime/memory/__tests__/memoryProject.test.ts',
  'src/runtime/memory/__tests__/harnessConversationCatalog.test.ts',
  'src/runtime/memory/__tests__/memoryToolRouting.test.ts',
  'src/runtime/memory/__tests__/memoryToolPolicy.test.ts',
  'src/runtime/memory/__tests__/fileTaskRuntime.test.ts',
  'src/runtime/memory/__tests__/skillCreatorToolExecutor.test.ts',
  'src/runtime/memory/__tests__/skillCreatorFileTreeDraft.test.ts',
  ...
  'src/utils/__tests__/pendingCanvasMedia.test.ts',
  ...
  'src/utils/__tests__/videoFrame.test.ts',
  ...
  'src/components/filetree/__tests__/projectFileTreeSort.test.ts',
  ...
  'src/composables/__tests__/useCreationBoluoAspect.test.ts',
  'src/components/chat/display/__tests__/autoScrollPolicy.test.ts',
  'src/utils/__tests__/fileSort.test.ts',
...
const legacyOrSupersededTests = [
  ...
  'src/runtime/skills/__tests__/skillPackageManifest.test.ts',
