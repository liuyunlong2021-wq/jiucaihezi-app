...
const wave1FocusedTests = [
  ...
  'src/components/__tests__/mediaUrlCaptureUi.test.ts',
  'src/components/__tests__/mediaWorkbenchUi.test.ts',
  ...
  'src/opencodeClient/__tests__/vaultContext.test.ts',
  ...
  'src/utils/__tests__/chatRunAudit.test.ts',
  ...
  'src/utils/__tests__/vaultRetrieval.test.ts',
  'src/utils/__tests__/vaultRuntime.test.ts',
  ...
  'src/utils/__tests__/vaultDomainSchema.test.ts',
  'src/utils/__tests__/vaultEvidencePlanner.test.ts',
  'src/utils/__tests__/vaultHealth.test.ts',
  'src/utils/__tests__/vaultFinalRuntimeScenarios.test.ts',
  'src/utils/__tests__/contextAssembly.test.ts',
  'src/utils/__tests__/messageEvidence.test.ts',
  ...
  'src/utils/__tests__/vaultPackage.test.ts',
  ...
  'src/utils/__tests__/sessionVaultCleanup.test.ts',
