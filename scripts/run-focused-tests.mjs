...
const wave1FocusedTests = [
  ...
  'src/runtime/memory/__tests__/wikiPlans.test.ts',
  'src/runtime/memory/__tests__/wikiTwoPhase.test.ts',
  'src/runtime/memory/__tests__/wikiSkillParity.test.ts',
  'src/runtime/agent/__tests__/taskProtocol.test.ts',
