...
const wave1FocusedTests = [
  ...
  'src/runtime/workbench/__tests__/productionWikiOutput.test.ts',
  'src/runtime/workbench/__tests__/productionWikiBinding.test.ts',
  'src/runtime/workbench/__tests__/productionWikiOutputStore.test.ts',
  'src/runtime/workbench/__tests__/productionWorkbench.test.ts',
  ...
  'src/components/workbench/__tests__/productionWorkbench.test.ts',
