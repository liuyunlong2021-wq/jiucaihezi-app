...
test('removed media model matcher blocks stale upstream names before capability inference', () => {
  ...
  assert.equal(isRemovedMediaModelId('runninghub/api/rh-grok-image-text'), true)
  assert.equal(isRemovedMediaModelId('rh-grok-image-text'), true)
  assert.equal(isRemovedMediaModelId('runninghub/api/rh-grok-image-image'), true)
  assert.equal(isRemovedMediaModelId('rh-grok-image-image'), true)
