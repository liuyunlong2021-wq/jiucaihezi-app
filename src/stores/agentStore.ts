...
const SKILL_PRESETS: SkillConfig[] = [
  ...
  // ═══ 小说创作全流程 ═══
  {
    id: 'preset_novel-orchestrator',
    name: '小说总控',
    description: '小说创作全流程总控。管理从灵感到成稿的 15 个阶段，推荐下一步 Skill，串联知识库上下文。',
    triggers: ['写小说', '小说创作', '开新书', '小说全流程', '创作流程', '写书'],
    skillContent: 'skill://novel-orchestrator/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-ideation',
    name: '灵感策划师',
    description: '从零生成小说创意概念。情绪引擎、救猫咪、发散穷举、核心梗公式等 6 大方法。',
    triggers: ['小说创意', '灵感策划', '故事概念', '高概念', '救猫咪', '情绪曲线'],
    skillContent: 'skill://novel-ideation/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-market-analysis',
    name: '市场分析师',
    description: '分析小说赛道竞争、读者画像、市场趋势。评估商业潜力，对标爆款找差异化。',
    triggers: ['市场分析', '读者画像', '赛道竞争', '商业潜力', '差异化'],
    skillContent: 'skill://novel-market-analysis/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-core-premise',
    name: '核心梗架构师',
    description: '将创意锤炼成高概念 Logline。构建核心冲突、反讽钩子和情感引擎。',
    triggers: ['核心梗', '高概念', 'Logline', '一句话梗概', '反讽钩子'],
    skillContent: 'skill://novel-core-premise/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-character-design',
    name: '角色设计师',
    description: '设计小说角色全维度。共情算法、原型分配、关系网、CP 化反、反派阴谋。含 20 个反差人设库。',
    triggers: ['角色设计', '人设', 'CP', '反派', '人物关系', '原型'],
    skillContent: 'skill://novel-character-design/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-outline',
    name: '大纲架构师',
    description: '构建全书结构大纲。三幕/四幕/节拍表，核心情节点、节奏控制、伏笔规划。',
    triggers: ['大纲', '结构', '三幕', '节拍表', '节奏', '伏笔'],
    skillContent: 'skill://novel-outline/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-chapter-plan',
    name: '章纲规划师',
    description: '将大纲拆解为逐章详细规划。每章目标、情绪曲线、信息释放、字数预算。',
    triggers: ['章纲', '章节规划', '情绪曲线', '信息释放'],
    skillContent: 'skill://novel-chapter-plan/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-packaging',
    name: '文案包装师',
    description: '书名生成、简介撰写、标签优化、封面文案。将故事卖点转化为市场吸引力。',
    triggers: ['书名', '简介', '文案包装', '标签', '卖点提炼'],
    skillContent: 'skill://novel-packaging/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-chapter-director',
    name: '章节导演',
    description: '负责全书关键节点的精彩呈现。情绪先行、确定性承诺、主角中心、人设保护、核心梗前置。',
    triggers: ['章节导演', '开篇', '转折', 'V章', '情绪先行'],
    skillContent: 'skill://novel-chapter-director/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-narrative-master',
    name: '叙事大师',
    description: '掌控叙事视角、时间调度、空间转换、节奏控制。多线叙事、POV 切换、闪回插叙。',
    triggers: ['叙事', '视角', 'POV', '时间线', '节奏', '多线'],
    skillContent: 'skill://novel-narrative-master/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-dialogue-expert',
    name: '对话专家',
    description: '设计角色对白、潜台词、信息密度。区分角色说话风格，让对话推动剧情。',
    triggers: ['对话', '对白', '潜台词', '角色语言', '信息密度'],
    skillContent: 'skill://novel-dialogue-expert/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-hook-designer',
    name: '钩子设计师',
    description: '设计章末钩子、悬念、反转。确保读者无法停下，每章结尾都有翻开下一页的冲动。',
    triggers: ['钩子', '悬念', '反转', '章末', '翻页欲'],
    skillContent: 'skill://novel-hook-designer/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-review-analyst',
    name: '复盘分析师',
    description: '全稿复盘、问题诊断。检查逻辑漏洞、节奏塌方、人设崩塌、情感断层。',
    triggers: ['复盘', '诊断', '漏洞', '节奏问题', '人设检查'],
    skillContent: 'skill://novel-review-analyst/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-polish',
    name: '文本润色师',
    description: '语言润色、风格统一、去冗余、增强表现力。让文字更精准、更有力量。',
    triggers: ['润色', '文笔', '风格统一', '增强表现力'],
    skillContent: 'skill://novel-polish/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-scene-builder',
    name: '场景构建师',
    description: '场景设计、空间调度、氛围营造。让每个场景都有明确的戏剧功能和感官体验。',
    triggers: ['场景', '空间', '氛围', '感官', '戏剧功能'],
    skillContent: 'skill://novel-scene-builder/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
  {
    id: 'preset_novel-conflict-builder',
    name: '冲突构建师',
    description: '冲突设计、张力曲线、对抗升级。确保故事的核心冲突推动所有情节。',
    triggers: ['冲突', '张力', '对抗', '矛盾', '升级'],
    skillContent: 'skill://novel-conflict-builder/SKILL.md',
    source: 'preset', tier: 'L1', version: 1,
    ...PRESET_DEFAULTS,
  },
]
