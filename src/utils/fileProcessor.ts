...
export const SUPPORTED_TEXT_EXT = /\.(txt|md|markdown|csv|json|jcscene|xml|html|css|js|jsx|ts|tsx|py|java|c|cpp|h|hpp|go|rs|sh|bash|zsh|yaml|yml|toml|sql|r|swift|kt|rb|php|dockerfile|env|ini|conf|log|vue|svelte|lua|pl|scala|zig|dart|makefile|cmake|srt|vtt)$/i
