...
const messages = {
  'zh-CN': {
    ...
    settings: {
      ...
      apiConfig: 'API 配置',
      toolsRepo: '工具仓库',
      toolsDesc: '通过 GitHub 安装第三方工具，我们只管理安装/卸载状态。',
      githubRecommended: 'GitHub 推荐安装',
      plugins: '插件',
      setupWizard: '工具设置向导',
      advancedExt: '高级扩展',
      scanning: '正在检测工具安装状态...',
    ...
    help: {
      ...
      dismiss: '关闭',
      chatTitle: '开始对话',
      chatText: '第 4 列始终是对话区。选择 Skill、项目文件夹或模型后，直接输入任务即可。',
      agentTitle: 'Skill',
  ...
  'en-US': {
    ...
    rail: {
      ...
      tools: 'Tools',
      mcp: 'External Tool Extensions',
            editor: 'Editor',
      ecommerce: 'Ecommerce Workbench',
      creation: 'Creation',
      files: 'Files',
      userCenter: 'Account',
      help: 'Help / Tutorials',
    ...
    settings: {
      ...
      toolsRepo: 'Tools',
      toolsDesc: 'Install third-party tools via GitHub. We only manage install status.',
      githubRecommended: 'Recommended',
      plugins: 'Plugins',
      setupWizard: 'Setup Wizard',
      advancedExt: 'Advanced',
    ...
    help: {
      ...
      chatText: 'The fourth column is always your chat area. Pick a skill, project folder, or model, then enter the task.',
      agentTitle: 'Skills',
