...
const messages = {
  'zh-CN': {
    ...
    help: {
      ...
      vaultTitle: '项目文件夹',
      vaultText: '项目文件夹就是当前上下文来源，OpenCode 会在用户选择的目录内读写和运行。',
      accountTitle: '账户和韭菜花',
  ...
  'en-US': {
    ...
    help: {
      ...
      vaultTitle: 'Project Folder',
      vaultText: 'The selected project folder is the working context. OpenCode reads, writes, and runs inside that directory.',
