...
const messages = {
  'zh-CN': {
    ...
    help: {
      eyebrow: '新手引导',
      title: '不用魔法即可使用 Claude、GPT、Gemini',
      openAccount: '打开用户中心',
      dismiss: '我知道了',
      chatTitle: '开始对话',
      chatText: '第 4 列始终是对话区。选择搭子、知识库或模型后，直接输入任务即可。',
      agentTitle: '搭子',
      agentText: '从搭子仓库启用现成工作流，也可以创建自己的搭子沉淀成 SKILL.md。',
      vaultTitle: '知识库',
  ...
  'en-US': {
    ...
    help: {
      ...
      title: 'Use Claude, GPT, and Gemini without extra setup',
      ...
      agentTitle: 'Skills',
      agentText: 'Enable ready-made workflows from the skill warehouse, or create your own skill as a SKILL.md workflow.',
