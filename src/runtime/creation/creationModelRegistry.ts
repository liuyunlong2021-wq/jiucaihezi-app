...
export const CREATION_MODEL_REGISTRY: CreationModelSpec[] = [
  ...
  // ── 🆕 Sora2 视频系列 (4 个) ──
  runninghubStandard({ id: 'runninghub/api/rh-sora2-text', model: 'rh-sora2-text', label: 'Sora2 文生视频', task: 'video', mode: 'text-to-video', price: 0.12, notes: ['docs/notes/RH-SORA2-4模型.md'], duration: { min: 10, max: 15 }, ratios: ['9:16','16:9'], resolutions: ['720p'] }),
  runninghubStandard({ id: 'runninghub/api/rh-sora2-image', model: 'rh-sora2-image', label: 'Sora2 图生视频', task: 'video', mode: 'image-to-video', price: 0.12, notes: ['docs/notes/RH-SORA2-4模型.md'], files: { images: { min: 1, max: 1 } }, duration: { min: 10, max: 15 }, ratios: ['9:16','16:9'], resolutions: ['720p'] }),
  runninghubStandard({ id: 'runninghub/api/rh-sora2-realistic', model: 'rh-sora2-realistic', label: 'Sora2 真人图生视频', task: 'video', mode: 'image-to-video', price: 1.0, notes: ['docs/notes/RH-SORA2-4模型.md'], files: { images: { min: 1, max: 1 } }, duration: { min: 4, max: 12 }, resolutions: ['720p'] }),
  runninghubStandard({ id: 'runninghub/api/rh-sora2-character', model: 'rh-sora2-character', label: 'Sora2 角色上传', task: 'video', mode: 'video-edit', price: 0.08, notes: ['docs/notes/RH-SORA2-4模型.md'], files: { videos: { min: 1, max: 1 } } }),
