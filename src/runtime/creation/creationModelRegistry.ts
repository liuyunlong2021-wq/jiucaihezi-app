...
export const CREATION_MODEL_REGISTRY: CreationModelSpec[] = [
  ...
  runninghubStandard({ id: 'runninghub/api/rh-sora2-realistic', model: 'rh-sora2-realistic', label: 'Sora2 真人图生视频', task: 'video', mode: 'image-to-video', price: 1.0, notes: ['docs/notes/RH-SORA2-4模型.md'], files: { images: { min: 1, max: 1 } }, fields: promptFields([{ key: 'duration', label: '时长', kind: 'select', defaultValue: '4', options: options(['4','8','12']) }]), resolutions: ['720p'] }),
