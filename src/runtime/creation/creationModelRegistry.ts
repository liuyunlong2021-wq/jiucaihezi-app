...
export const CREATION_MODEL_REGISTRY: CreationModelSpec[] = [
  ...
  // ── Seedance 2.0 多模态 (3 个) ──
  runninghubStandard({ id: 'runninghub/api/rh-seedance2-mini', model: 'rh-seedance2-mini', label: 'Seedance 2.0 Mini 多模态 · RunningHub', task: 'video', mode: 'workflow', price: 0.8, notes: ['docs/notes/runninghub-seedance9模型完整文档.md'], files: { images: { min: 0, max: 9 }, videos: { min: 0, max: 1 }, audios: { min: 0, max: 1 } }, duration: { min: 4, max: 15 }, resolutions: ['720p'] }),
  runninghubStandard({ id: 'runninghub/api/rh-seedance2-fast', model: 'rh-seedance2-fast', label: 'Seedance 2.0 Fast 多模态 · RunningHub', task: 'video', mode: 'workflow', price: 1.1, notes: ['docs/notes/runninghub-seedance9模型完整文档.md'], files: { images: { min: 0, max: 9 }, videos: { min: 0, max: 1 }, audios: { min: 0, max: 1 } }, duration: { min: 4, max: 15 }, resolutions: ['720p'] }),
  runninghubStandard({ id: 'runninghub/api/rh-seedance2', model: 'rh-seedance2', label: 'Seedance 2.0 多模态 · RunningHub', task: 'video', mode: 'workflow', price: 1.3, notes: ['docs/notes/runninghub-seedance9模型完整文档.md'], files: { images: { min: 0, max: 9 }, videos: { min: 0, max: 1 }, audios: { min: 0, max: 1 } }, duration: { min: 4, max: 15 }, resolutions: ['720p'] }),
