...
type Phase = 'idle' | 'organizing' | 'compiling' | 'done'
const phase = ref<Phase>('idle')
const progress = ref('')
const error = ref('')

const isBusy = () => phase.value === 'organizing' || phase.value === 'compiling'
...
<template>
  <div class="bp">
    ...
    <div v-if="progress" class="bp-progress">
      <span v-if="phase === 'organizing' || phase === 'compiling'" class="bp-spinner"></span>
      <span>{{ progress }}</span>
    </div>
