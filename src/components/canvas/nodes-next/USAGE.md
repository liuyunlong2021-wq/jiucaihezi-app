...
```vue
<script setup>
import { NodeFrame, useNodeBehavior, globalFreezeManager } from '@/components/canvas/v8'

const { onResizeHandlePointerDown, resizingId } = useNodeBehavior(node, {
