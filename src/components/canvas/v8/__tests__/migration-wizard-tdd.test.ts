...
describe('Migration Wizard TDD (Mig-001~004)', () => {
  ...
  test('remap 纯函数覆盖主要 legacy 类型', () => {
    ...
    assert.ok(true, '映射表 + remapNodeForV8 覆盖主要 case')
  })
})
