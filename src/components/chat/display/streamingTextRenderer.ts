  ...
  for (const line of lines) {
    ...
    if (fence) {
      if (inFence) {
        ...
        output.push(`<div class="md-code md-code-streaming"><div class="md-code-head"><span class="md-code-lang">${escapeHtml(lang)}</span><button class="md-code-copy" type="button" data-code-copy="1" aria-label="复制代码"><span class="md-code-copy-icon" aria-hidden="true">⧉</span><span class="md-code-copy-label">复制</span></button></div><pre><code>`)
        inFence = true
      }
      continue
    }
