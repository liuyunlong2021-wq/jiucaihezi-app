...
| 4 | Gemini 3.1 Flash Image · T8 直连 | `gemini-3.1-flash-image-preview` | `/v1/images/generations` | none | ✅ 上传触发 | partial |
| 5 | Gemini 3.1 Flash Image 2K · T8 直连 | `gemini-3.1-flash-image-preview-2k` | `/v1/images/generations` | none | ✅ 上传触发 | partial |
| 6 | Gemini 3 Pro Image · T8 直连 | `gemini-3-pro-image-preview` | `/v1/images/generations` | none | ✅ 上传触发 | partial |
