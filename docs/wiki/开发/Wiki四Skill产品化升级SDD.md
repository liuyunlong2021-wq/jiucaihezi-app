...
> 2026-08-06：本文的 `jc-cha-wiki`、`jc-raw-wiki`、`jc-jian-wiki` 合同已分别由 [[通用记忆工作台ChaWiki精准检索TDD]]、[[通用记忆工作台RawWiki精准沉淀TDD]]、[[通用记忆工作台JianWiki精准巡检TDD]] 取代，并由 [[通用记忆工作台RawChaJian证据链与可信检索TDD]] 统一补齐证据合同；`jc-xiu-wiki` 已按 [[通用记忆工作台XiuWiki精准修正TDD]] 实施。本文其余内容只保留历史证据价值。
...
> 以下是 2026-07-20 已实施的历史合同；现行实现见 [[通用记忆工作台ChaWiki精准检索TDD]]。
...
> 以下是 2026-07-20 已实施的历史合同；新目标与后续实施入口见 [[通用记忆工作台JianWiki精准巡检TDD]]。
...
> 以下是 2026-07-20 已实施的历史合同；新目标与后续实施入口见 [[通用记忆工作台XiuWiki精准修正TDD]]。
