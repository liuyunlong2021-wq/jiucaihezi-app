...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-image-g-2/image-to-image' \
...
| `aspectRatio` | String | 可选 | 枚举值: [1:1, 2:3, 3:2, 4:5, 5:4, 4:3, 3:4, 16:9, 9:16, 21:9, 9:21, 2:1, 1:2, 3:1, 1:3] |
| `resolution` | String | 可选 | 分辨率<br>枚举值: [1k, 2k, 4k] |
...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-image-g-2/text-to-image' \
--header "Content-Type: application/json" \
--header "Authorization: Bearer ${RUNNINGHUB_API_KEY}" \
--data-raw '{
...
| --- | --- | --- | --- |
| `prompt` | String | 必填 | 文本长度限制: 1 - 20000 |
| `aspectRatio` | String | 可选 | 枚举值: [1:1, 3:2, 2:3, 5:4, 4:5, 16:9, 9:16, 21:9, 3:4, 4:3, 9:21, 21:9, 1:2, 2:1, 1:3, 3:1] |
| `resolution` | String | 可选 | 分辨率<br>枚举值: [1k, 2k, 4k] |
