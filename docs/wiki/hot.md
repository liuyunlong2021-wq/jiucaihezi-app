...
> 上次刷新: 2026-07-30（`v2.1.1` main、Web Production、版本 tag 和桌面三平台 Release 已发布；Mac 流式与显示真实验收通过。Veo 3.1 Desktop 受保护结果下载缺少认证已完成根因分析、尚未修复；RunningHub 部分标准 API 迁移全球站，需逐端点验证；Windows/iPhone/iPad 真机矩阵未闭环；Android 继续暂停。）
