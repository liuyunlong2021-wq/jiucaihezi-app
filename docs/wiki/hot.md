...
2. **[[开发/Web云端项目Wiki媒体同步与APP升级SDD]]** — 只做三项 Web 等价适配：第二列项目树接 IndexedDB，模型使用 `read/glob/grep/write/edit` 和服务器 FFmpeg 截图，`skill` 按 description 渐进加载。
...
> 上次刷新: 2026-07-14（Web SDD 收紧为项目、工具、Skill 三项等价适配）
