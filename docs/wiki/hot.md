...
4. **[[开发/创作工作台架构SDD]]** — 创模式核心原则已统一：模型原生能力第一优先，产品能力补位，Skill 和工具按需增强，工具不得成为原生输入门槛。工作台以项目、Skill、媒体任务和画布组织漫剧、电商、自媒体等任务；当前视频只传摘要、工具无条件进入请求均属于待修实现缺口。
...
> 上次刷新: 2026-07-21（统一创模式核心原则；新增三项生产故障闭环 SDD；ZX Grok 参考图视频真实付费链路仍失败，已停止排查并留交接页。）
