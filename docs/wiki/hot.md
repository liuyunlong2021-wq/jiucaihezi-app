...
> 上次刷新: 2026-07-29（`v2.1.1` main、Web Production 和版本 tag 已发布；桌面三平台 GitHub Actions 构建中。Mac 流式与显示真实验收通过；Veo 3.1 Desktop 受保护结果下载缺少认证已完成根因分析、尚未修复；Windows/iPhone/iPad 真机矩阵未闭环；Android 继续暂停。）
