...
- [ ] **Step 1: Write failing tests for production content parts**
...
- [ ] **Step 3: Implement conservative capability routing**
...
- [ ] **Step 3: Implement the smallest uploader change**
...
- [ ] **Step 3: Implement Desktop wiring**
...
- [ ] **Step 3: Implement the policy and one-time consent**
...
- [ ] **Step 2: Verify RED, implement minimum branching, verify GREEN**
...
- [ ] **Step 2: Run real-request smoke tests**
...
- [ ] **Step 3: Update Wiki with proved facts only**
