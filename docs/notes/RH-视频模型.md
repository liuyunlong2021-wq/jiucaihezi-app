...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/rhart-video/ltx-2.3/image-to-video' \
--header "Content-Type: application/json" \
--header "Authorization: Bearer ${RUNNINGHUB_API_KEY}" \
--data-raw '{
  "imageUrl": "https://www.runninghub.cn/view?filename=fb33830583509648fe6e1b505654970daddcca84efa184a8fc1af493f68f3b18.png&type=input&subfolder=&Rh-Comfy-Auth=eyJ1c2VySWQiOiIzZjY1MTNlNWEwNjY1N2I4OGYyNjU5NTEzYmU3ZDM0YyIsInNpZ25FeHBpcmUiOjE3NzQ0OTM4NTc1MTgsInRzIjoxNzczODg5MDU3NTE4LCJzaWduIjoiMzFmMjE0YzkxZjkyNGFiYzQzYmY1YjRkNzhhOWYyMmYifQ==&Rh-Identify=3f6513e5a06657b88f2659513be7d34c&rand=0.2444301721186768",
  "prompt": "一点透视构图，太空驾驶舱内身着红色宇航服的人物紧握游戏手柄打游戏，头盔护目镜反射驾驶舱仪表盘光影；驾驶舱内宇航员在打游戏，驾驶舱外宇宙星云、星际尘埃呈流光状快速向后快速移动，时空隧道扭曲特效，蓝紫科幻光效交织，动态模糊 + 拖影营造时空穿越感，镜头稳定一点透视，胶片颗粒质感",
  "resolution": "480p",
  "aspectRatio": "16:9",
  "duration": 5
}'
...
| 参数说明 | 类型 | 必填/可选 | AI 应用程序生成的结果。 |
| --- | --- | --- | --- |
| `imageUrl` | String | 必填 | 最多支持 1 项图片，每张 30 MB |
| `prompt` | String | 必填 |  |
| `resolution` | String | 必填 | 枚举值: [480p, 720p, 1080p] |
| `aspectRatio` | String | 必填 | 枚举值: [9:16, 16:9] |
| `duration` | Int | 必填 | 输入范围值: 5 - 20 |
