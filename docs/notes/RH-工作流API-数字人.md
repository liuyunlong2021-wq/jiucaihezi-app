# 美团龙猫数字人Longcat T2V版对口型
接口:
/run/workflow/2002695647604162562
copy
LongCat avatar龙猫数字人文生视频对口型版
...
```curl
curl --location --request POST 'https://www.runninghub.cn/openapi/v2/run/workflow/2002695647604162562' \
...
| --- | --- | --- | --- |
| `addMetadata` | Boolean | 可选 | 是否在输出图片中添加工作流元数据 |
