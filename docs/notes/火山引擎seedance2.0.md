...
* <div data-tips="true" data-tips-type="tip">4K 视频采用 H.265 编码，少数播放环境可能不兼容，如遇问题，建议升级系统、更换设备或使用 VLC、MPV、QuickTime Player 等<a href="https://www.volcengine.com/docs/82379/2291680?lang=zh#4k_player">播放器</a>查看。</div>
