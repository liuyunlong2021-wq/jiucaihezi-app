...
### Phase 1: 推荐安装上线（1-2 天）

- [ ] 创建 `public/tools/registry.json`，首期录入 19 个精选工具（Serena 6 + Ren 10 + yt-dlp + Pixelle + so-novel）
...
**出口标准**：
- [ ] 推荐列表显示 19 个工具，Serena 6 → Ren 10 → 人工发现 3
...
### Serena 精选 · 视频创作 6 工具（排最前）

| # | 工具 | GitHub | 分类 | 一句话 |
|---|------|--------|------|--------|
| 1 | HyperFrames | heygen-com/hyperframes | AI | 一句话生成动效视频：HTML/CSS/动画渲染为 MP4 |
| 2 | video-use | browser-use/video-use | AI | AI 视频剪辑：去停顿/口头禅，加字幕/调色/动效 |
| 3 | Remotion Skills | remotion-dev/skills | AI | React 代码批量制作视频：排行榜/数据周报/固定栏目 |
| 4 | Generative Media Skills | SamurAIGPT/Generative-Media-Skills | AI | AI 视频生成工具箱：图片/视频/音频全栈 |
| 5 | videocut-skills | Ceeon/videocut-skills | AI | 中文视频剪辑：素材处理/字幕/短视频 |
| 6 | seedance2-skill | dexhunter/seedance2-skill | AI | 即梦 Seedance 2.0 专业提示词设计 |

### Ren 精选 · 内容创作 10 Skill

| # | 工具 | GitHub | ⭐ | 分类 | 一句话 |
|---|------|--------|-----|------|--------|
| 7 | guizang-ppt-skill | op7418/guizang-ppt-skill | 17K | AI | 一句话出杂志级 HTML 演示稿 |
| 8 | guizang-social-card-skill | op7418/guizang-social-card-skill | 3.5K | AI | 小红书竖版轮播图+公众号封面 |
| 9 | awesome-gpt-image-2 | freestylefly/awesome-gpt-image-2 | 7.3K | AI | gpt-image-2 生图：470+ 爆款模板 |
| 10 | Humanizer-zh | op7418/Humanizer-zh | 10K | AI | AI 文本去味人话化 |
| 11 | Deep-Research-skills | Weizhena/Deep-Research-skills | 1.1K | AI | 深度研究：大纲→搜索→报告 |
| 12 | anything-to-notebooklm | joeseesun/qiaomu-anything-to-notebooklm | 5.1K | AI | 一文多吃：转播客/PPT/思维导图/测验 |
| 13 | wewrite | oaker-io/wewrite | 2.3K | AI | 公众号一条龙 |
| 14 | Youtube-clipper-skill | op7418/Youtube-clipper-skill | 2K | AI | 长视频自动切短视频 |
| 15 | oh-story-claudecode | worldwonderer/oh-story-claudecode | 2.4K | AI | 网文选题脑暴+爆款拆解 |
| 16 | marketingskills | coreyhaines31/marketingskills | 33K | AI | 32 个营销 Skill（英文） |

### 人工精选 3 工具

| # | 工具 | GitHub | ⭐ | 分类 | 一句话 |
|---|------|--------|-----|------|--------|
| 17 | yt-dlp | yt-dlp/yt-dlp | 185K | 媒体 | 1800+ 网站视频/音频/字幕下载 |
| 18 | Pixelle-Video | AIDC-AI/Pixelle-Video | — | AI | AI 视频生成工作流引擎 |
| 19 | so-novel | freeok/so-novel | — | 工具 | 小说下载与阅读 |
...
> **下一步**: 确认方向 → 写 `registry.json`（19 个工具） + `GitHubToolRanking.vue`，总共约 400 行新代码。
