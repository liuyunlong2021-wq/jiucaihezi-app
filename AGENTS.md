...
>
> 最后更新：2026-06-30
> 当前发布基线：`v1.1.2` + **画布已移除** + **指令全覆盖（工具83条+Skill48条）** + **工具安装状态三段式检测** + **内置Skill自动播种** + **知识库内循环 Phase 1/2/2.5** + **小说/短剧临摹四件套 skill** + **项目文件树 VS Code Explorer 复刻** + **手机端适配 Phase 1** + **直连多模态贴图** + **上下文用量面板** + **Windows CSP/黑框修复**
>
