...
from ..models.mapping import get_rh_endpoint, get_rh_site, is_ai_app_model, get_webapp_id, matches_ai_app_registration, resolve_ai_app_id
...
async def _submit_via_app(
    ...
    wid = resolve_ai_app_id(webapp_id) or get_webapp_id(request.model)
    if not wid:
